...
export const REAL_USGS_TOPOGRAPHY: UsgsTopographicFeature[] = [
  ...
  },
  {
    ...
    name: "The Pinch of Peter's Canyon & Dry Fall",
    gnisName: 'Peters Canyon Pinch',
    elevationFt: 2120,
    elevationMeters: 646,
    quadrangle: "Mormon Flat Dam 7.5' Quad",
    geology: 'Sheer Dacite Slot Narrows, 15-ft Toehold Ledge, Pour-Off Dry Fall & Emerald Tinaja Pool',
    historicalNotes: 'Dramatic slot canyon constriction where Peters Canyon bends sharply westward toward Tortilla Creek. Famous for its slickrock obstacle negotiated by a 15-foot toehold ledge and a two-foot wooden ladder, chronicled by Jacob Emerick during his 2016 Malapais Loop trek under the watchful eyes of desert bighorn sheep.',
    position: { x: 238, z: -288 },
    featureCategory: 'canyon',
  },
  {
    id: 'malapais_sar_bivouac',
    name: "Jacob Emerick's 2016 Bivouac & SAR Extraction Site",
    gnisName: 'Peters Canyon Bivouac',
    elevationFt: 1940,
    elevationMeters: 591,
    quadrangle: "Mormon Flat Dam 7.5' Quad",
    geology: 'Natural Basalt Alcove Overhang & Alluvial Wash Terrace',
    historicalNotes: 'Historic backcountry emergency shelter site in lower Peters Canyon where solo hiker Jacob Emerick bivouacked after dark following a grueling descent from Malapais Mountain in June 2016, leading to a midnight helicopter rescue by Maricopa & Gila County Search and Rescue.',
    position: { x: 220, z: -305 },
    featureCategory: 'canyon',
  },
  {
    id: 'pistol_canyon',
